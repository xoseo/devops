...
data "archive_file" "start_scheduler" {
  type        = "zip"
  source_file = "./modules/task3_lambdas/start_instances.py"
  output_path = "./modules/task3_lambdas/start_instances.zip"
}

data "archive_file" "stop_scheduler" {
  type        = "zip"
  source_file = "./modules/task3_lambdas/stop_instances.py"
  output_path = "./modules/task3_lambdas/stop_instances.zip"
}
